...
namespace PokemonGameAPI.Application.Validators.BattleValidator
{
    public class BattleUpdateValidator : AbstractValidator<BattleUpdateDto>
    {
        public BattleUpdateValidator()
        {
